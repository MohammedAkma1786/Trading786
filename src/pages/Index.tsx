    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#F2FCE2] to-[#FDE1D3] dark:bg-[#1A1F2C]">
        ...
        <div className="flex items-center justify-center h-[calc(100vh-73px)]">
          <div className="neo-brutal-card p-6 mx-4 bg-white/80 border-[#9b87f5] dark:bg-[#403E43] dark:border-[#8A898C]">
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F2FCE2] to-[#FDE1D3] dark:bg-[#1A1F2C]">
      ...
      <div className="container py-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#7E69AB] to-[#9b87f5] dark:from-[#1EAEDB] dark:to-[#0EA5E9] bg-clip-text text-transparent">
            Trade Crypto with Confidence
          </h1>
          <p className="text-lg md:text-xl text-[#333333] dark:text-[#8E9196] mb-8">
            Access real-time cryptocurrency data and market insights to make informed trading decisions
          </p>
          <Link
            to="/high-potential"
            className="inline-flex items-center space-x-2 neo-brutal-card px-8 py-4 text-lg font-bold text-white bg-[#7E69AB] hover:bg-[#9b87f5] dark:bg-[#1EAEDB] dark:hover:bg-[#0FA0CE] transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="neo-brutal-card p-6 bg-white/80 border-[#D6BCFA] dark:bg-[#221F26] dark:border-[#403E43] backdrop-blur-lg">
            <TrendingUp className="w-12 h-12 text-[#7E69AB] dark:text-[#1EAEDB] mb-4" />
          ...
          <div className="neo-brutal-card p-6 bg-white/80 border-[#D6BCFA] dark:bg-[#221F26] dark:border-[#403E43] backdrop-blur-lg">
            <Shield className="w-12 h-12 text-[#7E69AB] dark:text-[#1EAEDB] mb-4" />
          ...
          <div className="neo-brutal-card p-6 bg-white/80 border-[#D6BCFA] dark:bg-[#221F26] dark:border-[#403E43] backdrop-blur-lg">
            <Zap className="w-12 h-12 text-[#7E69AB] dark:text-[#1EAEDB] mb-4" />
        ...
        <div className="space-y-8">
          <div className="flex flex-col items-center space-y-4">
            ...
            <Input
              ...
              className="neo-brutal-card max-w-md w-full bg-white/80 border-[#D6BCFA] dark:bg-[#221F26] dark:border-[#403E43] text-[#333333] dark:text-[#F1F0FB] placeholder-[#666666] dark:placeholder-[#8A898C]"
              value={search}
